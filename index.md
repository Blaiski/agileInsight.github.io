...
- The visualisation cleverly brings out your source code structure in a landscape-like interactive view, allowing you to visually see the building blocks that make up your system <sub>(from folder or packages, down to files and individual methods inside)</sub>.
