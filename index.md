...
- AgileInsight can visualise your source code using a state of the art 3D visualisation technique called city metahpor (or software map)☨
...
{: .note}** This is based on heirarchical treemap containment [#Ref CodeCity, SoftwareMap, and that old original work]
